...
public class TestStageManager : MonoBehaviour
{
    ...
    public static TestStageManager Instance;
    ...
    public void EnterPrepPhase()
    {
        ...
        TestGameManager.Instance.ResetPlayerUnits();  // snap players back
    ...
    public void EnterCombatPhase()
    {
        ...
        TestCombatManager.Instance.ClearProjectiles();
        TestUIManager.Instance.ShowFightButton(false);

        TestCombatManager.Instance.StartCombat();
    }
    ...
    private void ResetToPrepPhase()
    {
        ...
        TestCombatManager.Instance.ForceResetCombatState();
        ...
        TestCombatManager.Instance.RestorePlayerUnitsFromSnapshots();

        HaymakerAbility.CleanupAllDuplicateClones();

        foreach (var kvp in TestCombatManager.Instance.GetSavedPlayerPositions())
        {
            UnitAI unit = kvp.Key;
        ...
        TraitManager.Instance.EvaluateTraits(TestGameManager.Instance.playerUnits);
        TraitManager.Instance.ApplyTraits(TestGameManager.Instance.playerUnits);
        ...
        TestUIManager.Instance.ShowFightButton(true);
    ...
    private void CheckForAugmentSelection()
    {
            ...
            AugmentManager.Instance.ShouldOfferAugment(currentStage, roundInStage, roundsPerStage))
        {
            ...
            {
                TestUIManager.Instance.ShowStaticAugmentSelection(currentStage, roundInStage);
            }
        }
    }
